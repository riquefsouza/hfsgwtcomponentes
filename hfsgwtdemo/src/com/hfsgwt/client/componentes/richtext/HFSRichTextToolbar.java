...
public class HFSRichTextToolbar extends Composite {
	...
	private class EventHandler implements ClickHandler, ChangeHandler,
		...
		public void onClick(ClickEvent event) {
			...
			if (sender == bold) {
				...
				String url = Window.prompt("Digite uma URL de imagem:", "http://");
				if (url != null) {
					extended.insertImage(url);
				}
			} else if (sender == createLink) {
				String url = Window.prompt("Digite uma URL com link:", "http://");
				if (url != null) {
	...
	@SuppressWarnings("deprecation")
	public HFSRichTextToolbar(RichTextArea richText) {
		...
		if (basic != null) {
			bottomPanel.add(backColors = createColorList("Realce"));
			bottomPanel.add(foreColors = createColorList("Cor da fonte"));
